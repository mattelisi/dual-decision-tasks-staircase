...
% Open the screen
%[scr.window,  scr.windowRect] = PsychImaging('OpenWindow', scr.screenNumber, visual.grey/255, [0 0 1800 1200]/2, 32, 2); % debug
...
for t = 1:n_trials
    ...
    [pair2, country_pairs] = selectByDifficulty(country_pairs, gdp_diff);
